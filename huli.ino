...
static const float Kp_LUT[13][13] = {
    {1.5466f, 1.5352f, 1.5466f, 1.4553f, 1.4329f, 1.4329f, 1.4329f, 1.3499f, 1.2665f, 1.1832f, 1.0998f, 1.0998f, 1.0998f},  // e[0] = -16.0000
    {1.5352f, 1.5352f, 1.5352f, 1.4553f, 1.4327f, 1.3499f, 1.3499f, 1.3499f, 1.2667f, 1.1827f, 1.0809f, 1.0163f, 1.0163f},  // e[1] = -13.3333
    {1.5465f, 1.5351f, 1.5465f, 1.4553f, 1.4328f, 1.3498f, 1.2808f, 1.2851f, 1.2664f, 1.1827f, 1.0854f, 1.0163f, 0.9476f},  // e[2] = -10.6667
    {1.4553f, 1.4553f, 1.4553f, 1.4553f, 1.4327f, 1.3498f, 1.2671f, 1.1838f, 1.1833f, 1.0997f, 1.0163f, 1.0163f, 0.9338f},  // e[3] = -8.0000
    {1.4329f, 1.4329f, 1.4329f, 1.4329f, 1.4328f, 1.3498f, 1.2664f, 1.1833f, 1.1000f, 1.0163f, 0.9333f, 0.9332f, 0.9333f},  // e[4] = -5.3333
    {1.4329f, 1.4329f, 1.4329f, 1.3499f, 1.3497f, 1.2666f, 1.1832f, 1.0998f, 1.0165f, 0.9331f, 0.8500f, 0.8500f, 0.8500f},  // e[5] = -2.6667
    {1.4329f, 1.4329f, 1.4329f, 1.3499f, 1.2663f, 1.1832f, 1.0998f, 1.0164f, 0.9334f, 0.8500f, 0.7667f, 0.7668f, 0.7667f},  // e[6] = 0.0000
    {1.3499f, 1.3499f, 1.3499f, 1.2666f, 1.1831f, 1.0997f, 1.0163f, 1.0163f, 0.9333f, 0.8500f, 0.7668f, 0.7668f, 0.7668f},  // e[7] = 2.6667
    {1.2664f, 1.2665f, 1.2664f, 1.1832f, 1.0997f, 1.0163f, 0.9332f, 0.9332f, 0.9332f, 0.8500f, 0.7667f, 0.7668f, 0.7667f},  // e[8] = 5.3333
    {1.2659f, 1.1833f, 1.1833f, 1.0993f, 1.0159f, 0.9331f, 0.8500f, 0.8500f, 0.8500f, 0.8500f, 0.7660f, 0.7445f, 0.7445f},  // e[9] = 8.0000
    {1.2520f, 1.1833f, 1.1143f, 1.0013f, 0.9191f, 0.8501f, 0.7669f, 0.7670f, 0.7669f, 0.7662f, 0.7661f, 0.7444f, 0.6535f},  // e[10] = 10.6667
    {1.1832f, 1.1832f, 1.1187f, 0.9336f, 0.8500f, 0.8500f, 0.7668f, 0.7668f, 0.7668f, 0.7444f, 0.7444f, 0.7444f, 0.6648f},  // e[11] = 13.3333
    {1.0998f, 1.0998f, 1.0998f, 0.9331f, 0.7667f, 0.7668f, 0.7667f, 0.7668f, 0.7667f, 0.7444f, 0.6534f, 0.6648f, 0.6534f}   // e[12] = 16.0000
};

static const float Ki_LUT[13][13] = {
    {0.1602f, 0.1944f, 0.1602f, 0.4331f, 0.5002f, 0.5004f, 0.5002f, 0.7499f, 0.9995f, 1.2495f, 1.4996f, 1.4996f, 1.4996f},  // e[0] = -16.0000
    {0.1944f, 0.1944f, 0.1944f, 0.4331f, 0.5008f, 0.7500f, 0.7501f, 0.7500f, 0.9992f, 1.2495f, 1.4996f, 1.4996f, 1.4996f},  // e[1] = -13.3333
    {0.1602f, 0.1948f, 0.1604f, 0.4336f, 0.5006f, 0.7501f, 0.9567f, 0.9439f, 0.9999f, 1.2500f, 1.5001f, 1.5002f, 1.5001f},  // e[2] = -10.6667
    {0.1944f, 0.4330f, 0.4332f, 0.6817f, 0.7501f, 0.7501f, 0.9978f, 1.2479f, 1.2493f, 1.4992f, 1.7493f, 1.7492f, 1.7493f},  // e[3] = -8.0000
    {0.1602f, 0.4330f, 0.4983f, 0.7499f, 0.9998f, 0.9996f, 0.9998f, 1.2494f, 1.4992f, 1.7491f, 1.9991f, 1.9993f, 1.9991f},  // e[4] = -5.3333
    {0.4331f, 0.4331f, 0.4978f, 0.7499f, 1.0001f, 1.2495f, 1.2495f, 1.4990f, 1.7487f, 1.9994f, 2.2496f, 2.2496f, 2.2496f},  // e[5] = -2.6667
    {0.5002f, 0.5004f, 0.5002f, 0.7500f, 1.0002f, 1.2496f, 1.4996f, 1.7490f, 1.9988f, 2.2496f, 2.4988f, 2.4988f, 2.4988f},  // e[6] = 0.0000
    {0.5004f, 0.7499f, 0.7500f, 0.9999f, 1.2499f, 1.4992f, 1.7492f, 1.7492f, 1.9989f, 2.2497f, 2.5014f, 2.5663f, 2.5663f},  // e[7] = 2.6667
    {0.5003f, 0.7500f, 0.9566f, 1.2481f, 1.5000f, 1.7493f, 1.9992f, 1.9994f, 1.9992f, 2.2497f, 2.5007f, 2.5663f, 2.8398f},  // e[8] = 5.3333
    {0.9996f, 0.9997f, 1.2026f, 1.4977f, 1.7494f, 1.7507f, 2.0012f, 2.2495f, 2.2495f, 2.3181f, 2.5662f, 2.5663f, 2.8056f},  // e[9] = 8.0000
    {1.4984f, 1.4979f, 1.4984f, 1.7479f, 1.9990f, 2.0554f, 2.0425f, 2.2495f, 2.4983f, 2.5657f, 2.8396f, 2.8052f, 2.8398f},  // e[10] = 10.6667
    {1.4996f, 1.4996f, 1.4996f, 1.7491f, 1.9998f, 2.2496f, 2.2496f, 2.2496f, 2.4983f, 2.5663f, 2.8056f, 2.8056f, 2.8056f},  // e[11] = 13.3333
    {1.4996f, 1.4996f, 1.4996f, 1.7491f, 1.9995f, 2.2497f, 2.4988f, 2.4988f, 2.4988f, 2.5663f, 2.8398f, 2.8056f, 2.8398f}   // e[12] = 16.0000
};
